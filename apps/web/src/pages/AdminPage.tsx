...
export function AdminPage() {
  ...
  return <div className="page-wrap"><header className="page-hero compact"><div><span className="eyebrow">Safety operations</span><h1>System evidence, not theatre.</h1><p>Safety metrics, provider posture, and read-only operations context in one audit surface.</p></div><div className="hero-seal"><ShieldCheck/><strong>{String(metrics.data?.rule_version||'clinical-v1')}</strong><span>active rule pack</span></div></header>
